...
my $sampleID = basename( $sam , "_Chimeric.out.sam");
print "the sample ID is $sampleID\n";
my $id_list = shift;
print "your ID_list is: $id_list\n";
my $output = shift;
print "your output dir  is: $output\n";
...
$filename1 = $output."/".$sampleID."_FJR.sam";
$filename2 = $output."/".$sampleID."_chimericPE.sam";
