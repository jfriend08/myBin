...
"x86_64-linux-thread-multi-4.15.0-1058-aws" or
	die "Errno architecture (x86_64-linux-thread-multi-4.15.0-1058-aws) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
